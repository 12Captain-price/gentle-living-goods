...
import { useProducts, useTestimonials } from "@/lib/admin-data";

const Index = () => {
  const products = useProducts();
  const { testimonials } = useTestimonials();
  const newProducts = products.filter((p) => p.new);
  const dealProducts = products.filter((p) => p.salePrice !== undefined);
  ...
  const [featuredImage] = useContent(
    "home.featured.image",
    featuredCollection.heroImage || featuredCollection.image
  );
  ...
  return (
    <Layout>
          ...
          <div className="grid md:grid-cols-2 gap-8 lg:gap-16 items-center">
            ...
            >
              ...
              <p className="text-muted-foreground leading-relaxed mb-8 max-w-md">
                ...
                <Editable
                  k="home.featured.description"
                  defaultValue="From the trusted BIC Cristal to the iconic Parker Jotter — find a pen that suits the way you think, work and sign."
                />
              </p>
              <Button
                asChild
      ...
      {/* Deals — only shown when at least one product has an active sale price */}
        ...
        <div className="container-full">
          ...
          >
            <div className="text-[11px] font-semibold tracking-[0.3em] uppercase text-primary mb-3">
              <Editable k="home.collections.eyebrow" defaultValue="Browse By" />
            </div>
            <Editable as="h2" className="font-serif text-4xl md:text-5xl text-foreground block" k="home.collections.title" defaultValue="Collections" />
          </motion.div>
      ...
      <section className="py-24 md:py-32 bg-linen">
        <div className="container-narrow text-center">
          ...
          >
            ...
            <Editable
              as="h2"
              className="font-serif text-3xl md:text-4xl lg:text-5xl text-foreground leading-[1.3] mb-8 block"
              k="home.about.body"
              defaultValue="For over a decade, Stationery City has kept Bulawayo's classrooms, boardrooms and studios stocked — one honest pen, notebook and ream at a time."
            />
      ...
      {/* Testimonials — only shown once the admin has added at least one */}
            ...
            <div className="grid md:grid-cols-3 gap-8 md:gap-10">
              {testimonials.slice(0, 3).map((t, i) => (
                <motion.div
                  ...
                  className="bg-linen p-8 text-center"
                >
      ...
      <section className="py-24 md:py-32 bg-linen">
        <div className="container-narrow text-center">
          ...
          >
            ...
            <Editable as="h2" className="font-serif text-3xl md:text-4xl lg:text-5xl text-foreground mb-6 block" k="home.visit.title" defaultValue="Come Say Hello" />
            <p className="text-muted-foreground max-w-md mx-auto mb-10">
              Shop R4, Main Street Mall, between 14th and 15th Avenue on J. Nkomo Street, Bulawayo.
            </p>
            <Button
              asChild
              variant="outline"
              ...
              className="rounded-none px-10 py-6 text-sm tracking-[0.15em] uppercase"
            >
              <a href="tel:+263774098174">Call Us</a>
            </Button>
          </motion.div>
        </div>
      </section>
